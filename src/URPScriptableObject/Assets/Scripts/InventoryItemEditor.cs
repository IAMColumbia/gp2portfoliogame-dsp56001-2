    ...
    void OnGUI()
    {
        ...
        if (inventoryItemList != null)
        {
            ...
            if (inventoryItemList.itemList.Count > 0)
            {
                ...
                GUILayout.BeginHorizontal();
                inventoryItemList.itemList[viewIndex - 1].Strength = (float)EditorGUILayout.FloatField("Strength", inventoryItemList.itemList[viewIndex - 1].Strength, GUILayout.ExpandWidth(false));
                inventoryItemList.itemList[viewIndex - 1].Descteriry = (float)EditorGUILayout.FloatField("Descteriry", inventoryItemList.itemList[viewIndex - 1].Descteriry, GUILayout.ExpandWidth(false));
                inventoryItemList.itemList[viewIndex - 1].YEahYeahROhoda = (float)EditorGUILayout.FloatField("yEahYeahROhoda", inventoryItemList.itemList[viewIndex - 1].YEahYeahROhoda, GUILayout.ExpandWidth(false));
                GUILayout.EndHorizontal();
